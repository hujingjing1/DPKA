# DPMA Sparse-View CT Reconstruction

## Installation

To set up your environment for the DPMA model, you will need to install PyTorch, the ASTRA toolbox, and ODL. Follow the steps below:
...
Our work on the DPMA model has been inspired by and builds upon prior research in the field. We have referenced and adapted methodologies from the following significant works:
